    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-red-950 to-black p-4 overflow-hidden">
      ...
      <div className="glass-card p-8 max-w-2xl w-full mx-auto space-y-8 relative">
        <div className="flex flex-col items-center text-center space-y-6">
          ...
          <p className="text-lg text-red-300/90 animate-fade-in font-semibold tracking-wide">
        ...
        <div className="space-y-6 animate-fade-in">
          <div className="flex flex-wrap justify-center gap-4 text-white/90">
            <div className="flex items-center gap-2 hover:scale-110 transition-all duration-300 cursor-pointer bg-black/40 p-3 rounded-lg backdrop-blur-sm border border-red-500/30 hover:border-red-500/60 hover:bg-black/50 group">
              <Palette className="w-5 h-5 text-red-500 group-hover:text-red-400 transition-colors" />
              <span className="group-hover:text-red-200 transition-colors">UI/UX Design</span>
            </div>
            <div className="flex items-center gap-2 hover:scale-110 transition-all duration-300 cursor-pointer bg-black/40 p-3 rounded-lg backdrop-blur-sm border border-red-500/30 hover:border-red-500/60 hover:bg-black/50 group">
              <Code className="w-5 h-5 text-red-500 group-hover:text-red-400 transition-colors" />
              <span className="group-hover:text-red-200 transition-colors">Web & App Dev</span>
            </div>
            <div className="flex items-center gap-2 hover:scale-110 transition-all duration-300 cursor-pointer bg-black/40 p-3 rounded-lg backdrop-blur-sm border border-red-500/30 hover:border-red-500/60 hover:bg-black/50 group">
              <Gamepad className="w-5 h-5 text-red-500 group-hover:text-red-400 transition-colors" />
              <span className="group-hover:text-red-200 transition-colors">Game Seller</span>
            </div>
          </div>
          
          <p className="text-white/90 leading-relaxed bg-black/40 p-6 rounded-lg backdrop-blur-sm border border-red-500/30 hover:border-red-500/60 transition-all duration-300 hover:bg-black/50">
