  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-black via-red-950 to-black p-4 overflow-hidden">
      ...
      <div className="glass-card p-8 max-w-2xl w-full mx-auto space-y-8 relative z-10">
        <div className="absolute inset-0 bg-gradient-to-br from-black/70 to-black/80 rounded-xl backdrop-blur-sm"></div>
        ...
        <div className="relative space-y-6">
          ...
          <div className="relative mt-6">
            <div className="bg-black/50 rounded-xl p-5 h-[200px] overflow-y-auto custom-scrollbar border border-red-500/20 shadow-inner shadow-red-500/5">
          ...
          <div className="text-center text-sm bg-black/30 p-4 rounded-xl border border-red-500/10 flex flex-col items-center justify-center gap-4">
            <Button 
