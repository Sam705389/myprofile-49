...
export const DisclaimerDialog = () => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="glass-card sm:max-w-[425px] border-none p-0 overflow-hidden">
        <div className="relative p-6 bg-gradient-to-br from-black/90 via-black/80 to-black/90 backdrop-blur-xl">
          <DialogHeader>
            ...
            <DialogDescription className="space-y-6">
              ...
              <div className="relative group">
                ...
                <div className="relative p-5 bg-black/50 ring-1 ring-red-500/20 rounded-lg">
                  <p className="font-bold text-red-500 text-lg mb-2 animate-pulse">WARNING!</p>
